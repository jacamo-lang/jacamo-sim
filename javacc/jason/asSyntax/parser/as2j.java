...
*/
  final public boolean agent(Agent a) throws ParseException, jason.JasonException {Literal b;
                                Literal g;
                                Plan    p;
                                curAg = a;
    ...
    while (true) {
      ...
      endDir = directive(a);
if (endDir) {if ("" != null) return false;}
    }
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
/* Plan */
  final public Plan plan() throws ParseException {Token k;
...
/* Plan body */
  final public PlanBody plan_body() throws ParseException {Object F; PlanBody R = null;
    F = plan_body_term();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 45:{
      jj_consume_token(45);
...
if (R != null) {
  ...
  final public PlanBody plan_body_term() throws ParseException {Object F; PlanBody R = null;
    F = plan_body_factor();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TK_POR:{
...
{if ("" != null) return B;}
  ...
  final public PlanBody stmtIFCommon() throws ParseException {Object B; Term T1; Term T2 = null; Literal stmtLiteral = null;
    jj_consume_token(46);
    B = log_expr();
    jj_consume_token(47);
    T1 = rule_plan_term();
...
try {
  ...
  final public PlanBody stmtFOR() throws ParseException {Object B; Term T1; Literal stmtLiteral;
...
try {
  ...
  final public PlanBody stmtWHILE() throws ParseException {Object B; Term T1; Literal stmtLiteral;
...
/* Literal */
  final public Literal literal() throws ParseException {Pred F = null; Pred V; Token k; boolean type = Literal.LPos;
...
last = last.concat((ListTerm)f);
    ...
    jj_consume_token(55);
namespace = ons; {if ("" != null) return lt;}
    throw new Error("Missing return statement in function");
  }
...
/* logical expression */
  final public 
Object log_expr() throws ParseException {Object t1, t2;
    t1 = log_expr_trm();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 54:{
      jj_consume_token(54);
...
{if ("" != null) return t1;}
  ...
  final public Object arithm_expr_simple() throws ParseException {Token K; Object t; VarTerm v;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:{
...
if (!(t instanceof NumberTerm)) {
                                  ...
                                  {if ("" != null) return new ArithExpr(ArithmeticOp.plus, (NumberTerm)t);}
      break;
      }
    case 46:{
      jj_consume_token(46);
  ...
  private boolean jj_3R_31()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x1c00cb80,0x0,0x0,0x0,0x10000,0x1c00cb80,0x0,0x400c000,0x0,0x10000,0x0,0x0,0x0,0x0,0x0,0x0,0x1f32cf80,0x800000,0x1f32cf80,0x400000,0xc0000,0xc0000,0x0,0x0,0x0,0x0,0x0,0x0,0x1f00cf80,0x1c00c080,0x10000,0x0,0x0,0x0,0x1f32cf80,0x1c000080,0x1c000080,0x800,0x1c00c080,0x1c00cb80,0x400c000,0x0,0x0,0x0,0x1f00cf80,0x0,0x10000080,0x0,0x1f00cb80,0x1f00cb80,0x0,0x0,0x1f00cf80,0x1f00cb80,0x0,0x1f00cb80,0x0,0x0,0x0,0x3000,0x3000,0x0,0x1d00cb80,0x18000080,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4,0x80000,0x4,0x40,0x4,0xe00,0x80000,0x4,0x0,0x10,0x0,0x80,0x100,0xe00,0x1040,0x1040,0x2000,0x95644,0x0,0x95644,0x0,0x0,0x0,0x60200,0x60200,0x600,0x600,0x11640,0x11640,0x84604,0x0,0x0,0x80,0x2100,0x2100,0x95644,0x0,0x0,0x0,0x0,0x80000,0x0,0x4000,0x200000,0x100000,0x284604,0x100000,0x200000,0x400000,0x284604,0x284604,0x400000,0x1000000,0x84600,0x84600,0x7e060000,0x284604,0x7e060000,0x600,0x600,0x80000000,0x80000000,0x0,0x84600,0x0,0x200000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x2,0x0,0x0,0x0,};
   }
