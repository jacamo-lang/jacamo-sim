...
project.addAgent(ag);
  ...
  final public File fileName() throws ParseException {String path = "";
                              Token t;
                              Token i;
                              Token e;
                              String ext = ".asl";
...
//if (!path.startsWith(File.separator)) {
                              //  path = destDir + path;
                              //}
                              {if ("" != null) return new File( path + i.image + ext);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return l.toString();}
  ...
  final public Map ASoptions() throws ParseException {Map opts = new HashMap();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 46:{
      jj_consume_token(46);
...
{if ("" != null) return opts;}
  ...
  final public Map procOption(Map opts) throws ParseException {Token opt; Token oval;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ASOEE:{
...
project.setEnvClass(envClass);
  ...
  final public void control() throws ParseException {Token host =  null;
...
project.setControlClass(controlClass);
  ...
  final public void classpath() throws ParseException {Token cp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CLASSPATH:{
...
project.addClassPath(cp.image);
  ...
  final public void sourcepath() throws ParseException {Token cp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SOURCEPATH:{
...
project.addSourcePath(cp.image);
  ...
  final public void directives() throws ParseException {Token directiveId; ClassParameters directiveClass = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DIRECTIVE:{
